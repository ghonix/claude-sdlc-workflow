...
Claude Code stores plugin agent memories using the pattern `.claude/agent-memory/<plugin>-<agent-name>/MEMORY.md`. For ADLC agents (plugin: `adlc`), the directory names are:

| Agent name | Memory path |
|------------|-------------|
| `adlc-researcher` | `.claude/agent-memory/adlc-adlc-researcher/MEMORY.md` |
| `adlc-planner` | `.claude/agent-memory/adlc-adlc-planner/MEMORY.md` |
| `adlc-qa` | `.claude/agent-memory/adlc-adlc-qa/MEMORY.md` |
| `adlc-implementer` | `.claude/agent-memory/adlc-adlc-implementer/MEMORY.md` |
| `adlc-verifier` | `.claude/agent-memory/adlc-adlc-verifier/MEMORY.md` |

When an agent name is provided (e.g., `adlc-researcher`), construct the path as `.claude/agent-memory/adlc-<agent>/MEMORY.md`.
...
1. Glob `.claude/agent-memory/adlc-adlc*/MEMORY.md` to find all ADLC agent memory files (see Path resolution above)
...
1. Read `.claude/agent-memory/adlc-<agent>/MEMORY.md` (see Path resolution above)
...
1. Read `.claude/agent-memory/adlc-<agent>/MEMORY.md`
...
1. Check if `.claude/agent-memory/adlc-<agent>/MEMORY.md` exists
